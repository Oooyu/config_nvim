...
-- format
keymap.set("n", "<leader>fa",":lua vim.lsp.buf.format({ async = true })<CR>")

-- saga
keymap.set("n","gd",":Lspsaga peek_definition<CR>")
keymap.set("n","gD",":lua vim.lsp.buf.definition()<CR>")
keymap.set("n","gh",":Lspsaga lsp_finder<CR>")
...
keymap.set("v","<leader>ca",":Lspsaga code_action<CR>")
